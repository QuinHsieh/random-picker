let app = new Vue({
    el: '#app',
    data: {
        items: ["Have no idea what to eat?"],
        index: 0,
        running: false,
        eventBuffer: null,
        speed: 5,
...
let items = new Vue({
    ...
    data: {
        groups: [
            {
                "title": "Default Group",
                "items": "Enter options here and separate different options with newlines.\nFor example:\nOption 1\nOption 2\nClick the plus sign next to add a group and select the group to use by clicking on the circle."
            }
        ],
        activedIndex: 0,
        actived: "group-0"
